...
//where moves[i] represents its iᵗʰ move. Valid moves are 'R' (right), 'L' (left), 
//'U' (up), and 'D' (down). 
//
...
//of the origin. We return false because it is not at the origin at the end of its 
//moves.
// 
//
// 
...
// 
// Related Topics String Simulation 👍 1659 👎 713


package leetcode.editor.en

class N657_RobotReturnToOrigin {
